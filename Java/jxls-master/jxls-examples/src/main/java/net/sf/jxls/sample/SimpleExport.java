...
public class SimpleExport {
    private static String templateFileName = "d:/department.xls";
    ...
    public static void main(String[] args) throws IOException, ParsePropertyException, InvalidFormatException {
        ...
        System.out.println(SimpleExport.class.getClassLoader().getResource("").getPath());
        if(1==1)return;
...
//        transformer.transformXLS(templateFileName, beans, destFileName);
        Workbook wb = transformer.transformXLS(new FileInputStream(templateFileName), beans);
        wb.write(new FileOutputStream("d://xuewu.xls"));
    }
